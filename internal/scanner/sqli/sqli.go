...
// passes. The SQL `/* */` comment strip is what defeats the classic
// `UN/**/ION SE/**/LECT` evasion; URL-decode and NFKC catch the
// same payloads inside form data and Unicode-confusable variants.
